...
/**
 * DTO for updating an existing medication dosage record.
 * Contains all fields that can be updated for a dosage record.
 */
public record UpdateMedicationDosageRequest(
